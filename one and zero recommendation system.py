...
def platform():
      if 1<= CPV <= 9 and 1 <= CPC <= 5 :
            if Category == 1 or 2 or 5:
                  print("You should go with Email Ads") #less risk average sales
            else:
                  print("You should go with Other Site Ads") # affiliate as Other site

      elif 1 <= CPV <= 19 and 6 <= CPC <= 12:
            if Category == 1 or 2 or 5:
                  print("You should go with Facebook Ads") #little risk but more gain

            else:
                  print("You should go with Email and Other Site Ads") # good gain with little risk

      elif 20 <= CPV <= 40 and 13<= CPC <= 25:
            if Category == 1 or 2 or 5:
                  print("You should go with Facebook Ads and other site Ads")

            else :
                  print("you should go with youtube Ads or Email Ads")

      elif 41 <= CPV <= 58 and 26 <= CPC <= 50 :
            print("You should go with Google Ads")


      else:
            print("You should go with Google Ads Facebook Ads and Other Site Ads ")
